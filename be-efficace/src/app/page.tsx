  ...
  return (
    <main>
      <section className="relative bg-gradient-to-br from-blue-900 to-purple-800 text-white overflow-hidden">
        ...
        {/* <div className="absolute inset-0 bg-[url('https://be-efficace.com/background-texture.png')] bg-cover bg-center"></div> */}
        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            {/* Illustration - I will reuse the previous placeholder image logic */}
            <div className="mt-12">
              <Image
                src="https://via.placeholder.com/800x400/1E3A8A/FFFFFF?text=Illustration+Ecosysteme"
